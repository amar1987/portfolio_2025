        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="flex-shrink-0">
                <Image
                    ...
                    width={200}
                    height={200}
                    className="border-4 border-retro-border shadow-retro-outline object-cover"
                />
            </div>
            ...
            <div className="flex-1">
                <p className="font-mono  text-base leading-relaxed">
                    ...
                    CI/CD pipelines across distributed environments. Currently collaborating with ANWB
